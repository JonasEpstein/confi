...
**Regulators**. Federal and state regulatory agencies authorizing projects with long-term impacts to threatened and endangered species or aquatic resources may require prospective permittees to invest in compensatory mitigation practices that offset those residual impacts offsite as a condition of those permits. These agencies have developed a robust framework of Interagency Review Teams to ensure that mitigation projects uphold consistent principles and deliver sustained ecological outcomes commensurate with the impacts. Traditional environmental markets have expanded beyond single-asset credits into multi-resource projects as well as new asset types like stormwater mitigation.
...
**(NOTE FROM JE): Add brief blurb about a mitigation case study**
...
[^7]: Todd BenDor, T. William Lester, Avery Livengood, Adam Davis, and Logan Yonavjak, Estimating the Size of the Ecological Restoration Economy (2015), https://doi.org/10.1371/journal.pone.0128339 
